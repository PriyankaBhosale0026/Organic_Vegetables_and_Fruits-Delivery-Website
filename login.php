...
<body>
    ...
    <?php 
                            if(isset($_POST['btnlogin']))
                            {
                                ...
                                $Mobile= $_POST['txtuser'];
                                $pass=$_POST['txtpass'];
                                
                                
                                $sql = "select * from mst_login where Mobile='$Mobile' and Pass='$pass' and status='1'";  
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form  method="post" >
                                    ...
                                    <input type="text" placeholder="Enter Mobile" name="txtuser" required>
